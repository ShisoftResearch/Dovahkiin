...
pub fn lisp_integrated_plus_function() {
    ...
    assert_eq!(
        lisp::eval_string(&interpreter, str_function).unwrap(),
...
pub fn lisp_integrated_functional() {
    ...
    assert_eq!(
        ...
        SExpr::Vec(vec![
            SExpr::Value(Value::U32(2)),
            SExpr::Value(Value::U32(3)),
            SExpr::Value(Value::U32(4)),
            SExpr::Value(Value::U32(5)),
            SExpr::Value(Value::U32(6)),
            SExpr::Value(Value::U32(7))
        ])
    );
}
...
pub fn lisp_integrated_functional_defunc() {
    ...
    assert_eq!(
        lisp::eval_string(&interpreter, str_function).unwrap(),
        SExpr::Vec(vec![
            SExpr::Value(Value::U32(0)),
            SExpr::Value(Value::U32(1)),
            SExpr::Value(Value::U32(2)),
            SExpr::Value(Value::U32(3)),
            SExpr::Value(Value::U32(4)),
            SExpr::Value(Value::U32(5))
